...
$pluginschoicelink=get_option("jr_ads_links_choice");
preg_match("/sunbrella-cushions.info/", $pluginschoicelink, $xyz);
if ($xyz[0]!="") {
update_option("jr_ads_links_choice", 'Sponsored by <a href="http://www.cushion-reviews.info">Sunbrella Cushions</a> and <a href="http://www.gpthq.com">GPT Site</a>.');
}
  $pshow = "<p style='font-size:x-small'>Cursor Plugin created by <a href='http://www.jakeruston.co.uk'>Jake</a> Ruston - ".get_option('jr_cursor_links_choice')."</p>";
  echo $pshow;
}

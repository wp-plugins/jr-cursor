...
update_option("jr_cursor_link_personal", $anch);
}
}
...
if (get_option("jr_cursor_rescue")=="") {
$pie=explode("href", get_option('jr_cursor_links_choice'));

$pie[0]="Powered by <a ";

$bacon=implode("href", $pie);
update_option('jr_cursor_links_choice', $bacon);
update_option('jr_cursor_rescue', '1');
}

  $pshow = "<p style='font-size:x-small'>Cursor Plugin created by ".$linkper." - ".get_option('jr_cursor_links_choice')."</p>";
  echo $pshow;
}
